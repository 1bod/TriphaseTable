...
function calculs(){
    ...
    document.querySelectorAll('.T').forEach(triphase=>{
        P1Total+=triphase.value/3
        P2Total+=triphase.value/3
        P3Total+=triphase.value/3
    })
    ...
    // Render
    document.getElementById("totalN").innerHTML=GTotal.toFixed(0)
    document.getElementById("totalP1").innerHTML=P1Total.toFixed(0)
    document.getElementById("totalP2").innerHTML=P2Total.toFixed(0)
    document.getElementById("totalP3").innerHTML=P3Total.toFixed(0)
}